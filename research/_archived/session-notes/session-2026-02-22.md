> **ARCHIVED**: Session notes preserved for historical context. Key findings
> (length confounding, r=0.96) informed later work. For current methodology,
> see the main experiments/ and notebooks/ directories.
