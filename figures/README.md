...
Visualizations from the latent diagnostics analysis.
...
|--------|-------------|--------|
| `central_summary.png/pdf` | **MAIN FIGURE.** 8-panel comprehensive summary showing all key results | ✅ Complete |
| `truthfulness_overlap.png/pdf` | Negative result: true/false statements completely overlap (d=0.05) | ✅ Complete |
| `domain_distributions.png/pdf` | Histograms of residualized metrics by task domain | ✅ Complete |
| `pca_clustering.png/pdf` | PCA projection showing domain clustering (length-controlled) | ✅ Complete |
| `boxplots_significance.png/pdf` | Box plots per domain with effect sizes | ✅ Complete |
| `length_control_comparison.png/pdf` | Before/after length control: shows N Active collapses, Influence/Concentration persist | ✅ Complete |
| `detection_summary.png/pdf` | Visual summary of what topology can/cannot detect | ✅ Complete |
| `correlation_heatmap.png/pdf` | Correlation matrix showing length confound on N Active | ✅ Complete |
